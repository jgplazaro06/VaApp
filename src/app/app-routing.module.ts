...
const routes: Routes = [
  ...
  { path: 'nominations', loadChildren: './nominations/nominations.module#NominationsPageModule' },
  ...
  { path: 'travel-request', loadChildren: './travel-request/travel-request.module#TravelRequestPageModule' },
  ...
  { path: 'pdf-votes', loadChildren: './pdf-votes/pdf-votes.module#PdfVotesPageModule' }
];
