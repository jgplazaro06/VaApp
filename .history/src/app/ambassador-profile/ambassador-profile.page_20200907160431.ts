  ...
  constructor(private aroute: ActivatedRoute,
    ...
    this.aroute.queryParams.subscribe(params => {
      if (this.router.getCurrentNavigation().extras.state) {
        this.ambassador.fromJson(this.router.getCurrentNavigation().extras.state.data);

        console.log(this.ambassador.IRID)
        this.sqlSvc.getAmbassadorsData({ id: this.ambassador.IRID }).then(val => {
          console.log(val)
