      ...
      .toPromise().then(resp => {
        ...
        if (r.length > 0) {
          ...
          r.forEach(a => {
            ...
            amb.fromJson(a);
            console.log(amb)
            if (amb.Image.includes('www.the-v.net')) amb['imgUrl'] = amb.Image.replace('www.the-v.net', 'site.the-v.net')
            else if (amb.Image.includes('http://the-v.net')) amb['imgUrl'] = amb.Image.replace('http://the-v.net', 'http://site.the-v.net')
